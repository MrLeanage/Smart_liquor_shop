...
public class AgencyProductServices {
                            ...
                            try{
                                ...
                                while (rsFindSupplierData.next()){
                                    if(!(rsFindSupplierData.getString(1).isEmpty() || rsFindSupplierData.getString(1).equals(null))){
                                        ...
                                        agencyProductsData.add(new AgencyProduct(rsLoadAgencyProduct.getString(1), rsLoadAgencyProduct.getString(2),rsFindSupplierData.getString(1), rsFindSupplierData.getString(2),rsLoadAgencyProduct.getInt(3),rsLoadAgencyProduct.getString(4),rsLoadAgencyProduct.getFloat(5),rsLoadAgencyProduct.getFloat(6), rsLoadAgencyProduct.getFloat(7),rsLoadAgencyProduct.getString(8),rsLoadAgencyProduct.getString(9),rsLoadAgencyProduct.getString(10),rsLoadAgencyProduct.getString(11), rsLoadAgencyProduct.getString(12)));
                            ...
                            try{
                                ...
                                while (rsFindSupplierData.next()){
                                    if(!(rsFindSupplierData.getString(1).isEmpty() || rsFindSupplierData.getString(1).equals(null))){
                                        ...
                                        agencyProduct.setAPBarcode(rsLoadAgencyProduct.getString(12));
                                    }else{
                                        AlertPopUp.sqlRecordNotFound("Supplier");
                                    }
                                }
    ...
    public boolean insertData(AgencyProduct agencyProduct) throws  Exception{
        ...
        try {
            ...
            psAgencyProduct.setString(11, agencyProduct.getAPBarcode());
    ...
    public boolean updateData(AgencyProduct agencyProduct) throws Exception {
        ...
        try {
            ...
            psAgencyProduct.setString(10,agencyProduct.getAPBarcode());
            psAgencyProduct.setInt(11,UtilityMethod.seperateID(agencyProduct.getaPID()));
            psAgencyProduct.execute();
            status = true;
            if(status){
                try{
                            ...
                            try{
                                ...
                                while (rsFindSupplierData.next()){
                                    if(!(rsFindSupplierData.getString(1).isEmpty() || rsFindSupplierData.getString(1).equals(null))){
                                        ...
                                        agencyProductData.add(new AgencyProduct(rsLoadAgencyProduct.getString(1), rsLoadAgencyProduct.getString(2),rsFindSupplierData.getString(1), rsFindSupplierData.getString(2),rsLoadAgencyProduct.getInt(3),rsLoadAgencyProduct.getString(4),rsLoadAgencyProduct.getFloat(5),rsLoadAgencyProduct.getFloat(6), rsLoadAgencyProduct.getFloat(7),rsLoadAgencyProduct.getString(8),rsLoadAgencyProduct.getString(9),rsLoadAgencyProduct.getString(10),rsLoadAgencyProduct.getString(11), rsLoadAgencyProduct.getString(12)));
