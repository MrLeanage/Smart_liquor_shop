...
public class AgencyProductsController implements Initializable {
    ...
    @FXML
    private Label APBarcodeLabel;

    @FXML
    private TextField APBarcodeTextBox;
    ...
    private boolean dataValidate(){
        ...
        if(DataValidation.TextFieldNotEmpty(APProductNameTextBox)
                ...
                && DataValidation.TextFieldNotEmpty(APBarcodeTextBox)
                ...
                && DataValidation.isValidNumberFormat(APBarcodeTextBox.getText())
    ...
    private void dataValidateMessage(){
        ...
        if(!(DataValidation.TextFieldNotEmpty(APProductNameTextBox.getText())
            ...
            DataValidation.TextFieldNotEmpty(APBarcodeTextBox, APBarcodeLabel, "Barcode is Required");
    ...
    private void addData(ActionEvent event) throws Exception{
        ...
        if(dataValidate()){
            ...
            agencyProductModel.setAPBarcode(APBarcodeTextBox.getText());
    ...
    private void loadSelectedData( ){
        ...
        try{
            ...
            APBarcodeTextBox.setText(agencyProductModel.getAPBarcode());
