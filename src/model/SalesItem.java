...
public class SalesItem {
    ...
    private StringProperty sIPBarcode = null;
    ...
    public SalesItem(String sIPID, String sIPName, String sIPWeight, Float sIUnitPrice,  String sIType, String sIStatus, String sIPBarcode) {
        ...
        this.sIPBarcode = new SimpleStringProperty(sIPBarcode);
    }
    ...
    public String getsIPBarcode() {
        return sIPBarcode.get();
    }

    public StringProperty sIBarcodeProperty() {
        return sIPBarcode;
    }

    public void setsIPBarcode(String sIPBarcode) {
        this.sIPBarcode = new SimpleStringProperty(sIPBarcode);
    }
}
